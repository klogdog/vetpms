...
class VetPMSApplication {
    ...
    this.state = {
      ...
      parties: [
        {
          ...
          address: '101 Bunker Hill, LA',
        },
        {
          id: 'party-2',
          name: 'Marcus Wright',
          phone: '555-2018',
          email: 'marcus@cyberdyne.com',
          address: '404 Skynet Blvd, LA',
        },
        {
          id: 'party-3',
          name: 'John Connor',
          phone: '555-1997',
          email: 'john.connor@hqpms.org',
          address: '202 Sector Seven, LA',
        },
      ],
      ...
      animals: [
        ...
        },
        {
          ...
          soap: {
            subjective:
              'Presented for vomiting since yesterday. Suspected ingestion of a rubber dog toy 36h ago.',
          ...
          invoices: [
            {
              item: 'Emergency Triage Assessment Fee',
              price: 150.0,
              category: 'Professional Service',
            },
            {
              item: 'Intravenous Catheter & Fluids',
              price: 145.0,
              category: 'Medical Consumables',
            },
          ],
        },
        {
          ...
          soap: {
            subjective:
              'Acute collapse at park today. History of mitral valve disease. Heavy coughing.',
            objective:
              'Tachycardic (HR 165), murmur Grade V/VI heard bilaterally. Respiration rapid and labored with crackles.',
          ...
          invoices: [
            { item: 'Critical Care ICU Boarding (First Day)', price: 290.0, category: 'Ward Fee' },
            {
              item: 'Continuous Oxygen Chamber Administration',
              price: 240.0,
              category: 'Professional Service',
            },
          ],
        },
        {
          ...
          invoices: [
            {
              item: 'Senior Canine Wellness Wellness Exam',
              price: 75.0,
              category: 'Professional Service',
            },
          ],
  ...
  initEventListeners() {
    ...
    document
      ...
      .addEventListener('click', () => this.openModal(this.checkinModal));
    document
      .getElementById('btn-close-checkin-modal')
      .addEventListener('click', () => this.closeModal(this.checkinModal));
    ...
    document
      .getElementById('btn-close-substance-modal')
      .addEventListener('click', () => this.closeModal(this.substanceModal));
  }
  ...
  handlePatientCheckinSubmit() {
    ...
    const newAnimal = {
      ...
      invoices: [
        {
          item: 'Standard Client Admission Outpatient Fee',
          price: 65.0,
          category: 'Professional Service',
        },
      ],
    ...
    this.showToast(
      `Patient <b>${name}</b> (${species}) admitted. Client: <b>${ownerName}</b>!`,
      'success'
    );
